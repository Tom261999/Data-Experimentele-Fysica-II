...
[t_gem_2,v_gem_2] = importdatabohr('globaal\gemeten potentiaal\set 2.txt');
[t_gem_3,v_gem_3] = importdatabohr('globaal\gemeten potentiaal\set 3.txt');
[t_gem_4,v_gem_4] = importdatabohr('globaal\gemeten potentiaal\set 4.txt');
[t_gem_5,v_gem_5] = importdatabohr('globaal\gemeten potentiaal\set 5.txt');